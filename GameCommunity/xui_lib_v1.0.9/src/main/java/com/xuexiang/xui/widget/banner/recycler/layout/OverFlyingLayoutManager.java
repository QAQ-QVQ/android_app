...
public class OverFlyingLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     * When set to true, If {@link android.support.recyclerview.widget.RecyclerView} is LTR, than it will
     * layout from RTL, if {@link android.support.recyclerview.widget.RecyclerView}} is RTL, it will layout
     * from LTR.
     */
