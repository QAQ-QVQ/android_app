...
//        }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            this.widgetColor = ThemeUtils.resolveColor(context, R.attr.colorAccent, materialBlue);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            this.buttonRippleColor =
                    ThemeUtils.resolveColor(
                            ...
                            ThemeUtils.resolveColor(context, R.attr.colorControlHighlight, fallback));
        ...
        /**
         * Sets a custom {@link android.support.recyclerview.widget.RecyclerView.Adapter} for the dialog's list
         *
